...
const FiltrosComponent: React.FC<FiltrosComponentProps> = () => {
    return (
        <div className="Filtros">
            <div className="Busqueda">
                <label >Search</label>
                <div className="ContenedorBusqueda">
                    <input type="text" id="input-busqueda" placeholder="Keywords" >
                    </input>
                    <button type="button" className="boton-busqueda">
            ...
            <div className="generos-listaDesplegable">
                <label>Generes</label>
                <select id="generos">
